...
| <a id="COM_RC_STICK_OV"></a>[COM_RC_STICK_OV](../advanced_config/parameter_reference.md#COM_RC_STICK_OV) | The minimum stick deflection required to trigger a transition to [Position mode](../flight_modes_mc/position.md) (if [COM_RC_OVERRIDE](#COM_RC_OVERRIDE) is enabled). The stick must also be actively moving; a stick held statically at any deflection will not trigger override. <Badge type="tip" text="PX4 v1.18" />                                                                                                |
